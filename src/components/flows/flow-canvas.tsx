...
function CanvasAddNodeButton() {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open && (
        <div className="absolute left-0 mt-1.5 z-50 w-[268px] rounded-lg bg-popover p-1.5 text-popover-foreground shadow-lg ring-1 ring-foreground/10 border border-border">
